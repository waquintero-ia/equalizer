const Footer = () => {
  return(
    <>
      <div className="footer px-5 pt-64 pb-80 md:px-10 xlg:px-80">
        <div className="footer-container flex flex-col gap-32 xlg:w-1120 xlg:mx-auto xlg:flex-row xlg:gap-128">
          <img className="w-[144px] h-[32px]" src="./assets/logo.svg" alt="equalizer" loading="lazy" decoding="async"/>
          
          <div className="footer-content text-slate leading-150 w-full">
            <p>
            ...
            <div className="flex flex-row w-full justify-between">
              ...
              <div className="socials-media flex gap-32 xs:hidden md:flex md:w-[124px] md:h-[20px] items-center">
                <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" tabIndex={0}>
                ...
                <svg width="20" height="17" xmlns="http://www.w3.org/2000/svg" tabIndex={0}>
          ...
          <div className="socials-media flex gap-32 md:hidden">
            <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" tabIndex={0}>
              <path d="M18.896 0H1.104C.494 0 0 .494 0 1.104v17.793C0 19.506.494 20 1.104 20h9.58v-7.745H8.076V9.237h2.606V7.01c0-2.583 1.578-3.99 3.883-3.99 1.104 0 2.052.082 2.329.119v2.7h-1.598c-1.254 0-1.496.597-1.496 1.47v1.928h2.989l-.39 3.018h-2.6V20h5.098c.608 0 1.102-.494 1.102-1.104V1.104C20 .494 19.506 0 18.896 0Z" fill="currentColor"/>
            </svg>
            <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" tabIndex={0}>
